# spam-email-analysis
spam email analysis ( MultinomialNB - pandas - regular expression - nltk - CountVectorizer - naïve bayes - confusion matrix - precision - recall - f1-score - CountVectorizer - TfidfVectorizer )
